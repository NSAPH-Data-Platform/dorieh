"""
A utility that executes test cases generated by the
`dorieh.platform.dbt.create_test` tool.

A failed test means that the content of the table differs from the
snapshot taken when the test script was generated -- either a pipeline
regression or a legitimate upstream data revision. In the latter case,
regenerate the test script with `dorieh.platform.dbt.create_test`.
"""
